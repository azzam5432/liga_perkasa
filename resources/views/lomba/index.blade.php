                    ...
                    <tr>
                        ...
                        <td class="col-sticky-right text-center">
                            <div class="d-flex gap-1 justify-content-center">
                                ...
                                @if($item->jenis == 'penyisihan')
                                    <a href="{{ route('finalis.index', $item->id_lomba) }}" class="btn-action btn-success" title="Lihat Finalis">
                ...
                <form id="formEditLomba" action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Jenis Lomba <span class="text-danger">*</span></label>
                                <div class="row g-2" id="editJenisContainer">
                                    <div class="col-6">
                                        <div class="jenis-card" data-value="langsung" onclick="pilihJenisEdit(this)">
                                            <div class="jenis-title">Tanpa Babak</div>
                                            <div class="jenis-desc">Langsung dinilai</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="jenis-card" data-value="penyisihan" onclick="pilihJenisEdit(this)">
                                            <div class="jenis-title">Penyisihan + Final</div>
                                            <div class="jenis-desc">Ada babak final</div>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" id="edit_jenis" name="jenis" value="">
                            </div>
                        </div>
                    </div>
