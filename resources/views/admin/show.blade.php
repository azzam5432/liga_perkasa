        ...
        <div class="card shadow-lg border-0">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-2 mt-4 pt-3 border-top">
                    <a href="{{ route('admin.edit', $tim->id_tim) }}" class="btn btn-warning text-white rounded-pill px-4">
                        <i class="fas fa-edit me-1"></i> Edit Tim
                    </a>
                    <a href="{{ route('admin.index') }}" class="btn btn-secondary rounded-pill px-4">
                        <i class="fas fa-arrow-left me-1"></i> Kembali
                    </a>
                    <form action="{{ route('admin.destroy', $tim->id_tim) }}" method="POST" class="d-inline ms-auto">
                        @csrf
                        @method('DELETE')
