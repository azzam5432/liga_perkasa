                ...
                <form action="{{ route('kriteria.update', $kriteria->id_kriteria) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                  id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $kriteria->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('bobot') is-invalid @enderror" 
                                       id="bobot" name="bobot" value="{{ old('bobot', $kriteria->bobot) }}" min="0" max="100" required>
                                @error('bobot')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tipe') is-invalid @enderror" 
                                    ...
                                    <option value="skala" {{ old('tipe', $kriteria->tipe) == 'skala' ? 'selected' : '' }}>Skala</option>
                                    <option value="pilihan_ganda" {{ old('tipe', $kriteria->tipe) == 'pilihan_ganda' ? 'selected' : '' }}>Pilihan Ganda</option>
                                    <option value="teks" {{ old('tipe', $kriteria->tipe) == 'teks' ? 'selected' : '' }}>Teks</option>
                                </select>
                                @error('tipe')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('skala_min') is-invalid @enderror" 
                                       id="skala_min" name="skala_min" value="{{ old('skala_min', $kriteria->skala_min) }}">
                                @error('skala_min')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('skala_max') is-invalid @enderror" 
                                       id="skala_max" name="skala_max" value="{{ old('skala_max', $kriteria->skala_max) }}">
                                @error('skala_max')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
