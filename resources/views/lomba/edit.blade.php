...
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-10">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-gradient-warning text-white" style="background: linear-gradient(135deg, #f6c23e, #dda20a);">
                <h5 class="mb-0"><i class="fas fa-edit me-2"></i> Edit Lomba</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form action="{{ route('lomba.update', $lomba->id_lomba) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        <label for="nama_lomba" class="form-label fw-bold">
                            <i class="fas fa-trophy text-dark me-1"></i> Nama Lomba <span class="text-danger">*</span>
                        </label>
                        <input type="text" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="draft" {{ old('status', $lomba->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="open" {{ old('status', $lomba->status) == 'open' ? 'selected' : '' }}>Open</option>
                                <option value="closed" {{ old('status', $lomba->status) == 'closed' ? 'selected' : '' }}>Closed</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                  ...
                                  name="deskripsi" 
                                  rows="4" 
                                  placeholder="Masukkan deskripsi lomba">{{ old('deskripsi', $lomba->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   ...
                                   id="tanggal_mulai" 
                                   name="tanggal_mulai" 
                                   value="{{ old('tanggal_mulai', $lomba->tanggal_mulai ? $lomba->tanggal_mulai->format('Y-m-d') : '') }}">
                            @error('tanggal_mulai')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('tanggal_selesai', $lomba->tanggal_selesai ? $lomba->tanggal_selesai->format('Y-m-d') : '') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="kuota_tim" 
                                   name="kuota_tim" 
                                   value="{{ old('kuota_tim', $lomba->kuota_tim) }}" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="min_anggota" 
                                   name="min_anggota" 
                                   value="{{ old('min_anggota', $lomba->min_anggota) }}" 
                                   min="1" 
                                   max="20" 
                                   required>
                            @error('min_anggota')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="max_anggota" 
                                   name="max_anggota" 
                                   value="{{ old('max_anggota', $lomba->max_anggota) }}" 
                                   min="1" 
                                   max="20" 
                                   required>
                            @error('max_anggota')
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-warning text-white rounded-pill px-4" style="background: linear-gradient(135deg, #f6c23e, #dda20a); border: none;">
                            <i class="fas fa-save me-1"></i> Update Lomba
                        </button>
                    </div>
                </form>
            </div>
