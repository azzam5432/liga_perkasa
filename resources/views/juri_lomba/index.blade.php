                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="modal_user_id" name="user_id" required>
                            ...
                            @foreach($users ?? [] as $user)
                                <option value="{{ $user->id }}">{{ $user->name }} - {{ $user->jabatan ?? 'Panitia' }}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditPenugasan" action="" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="edit_id_juri" class="form-label">Pilih Panitia <span class="text-danger">*</span></label>
                        <select class="form-select" id="edit_id_juri" name="id_juri" required>
                            <option value="">-- Pilih Panitia --</option>
                            @foreach($juri ?? [] as $j)
                                <option value="{{ $j->id_juri }}">{{ $j->user->name }} - {{ $j->spesialisasi ?? 'Panitia' }}</option>
                            @endforeach
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="edit_id_lomba" class="form-label">Pilih Lomba <span class="text-danger">*</span></label>
                        <select class="form-select" id="edit_id_lomba" name="id_lomba" required>
                            <option value="">-- Pilih Lomba --</option>
                            @foreach($lomba ?? [] as $l)
                                <option value="{{ $l->id_lomba }}">{{ $l->nama_lomba }}</option>
                            @endforeach
...
document.getElementById('btnSimpanPenugasan').addEventListener('click', function() {
    ...
    if (!userId) {
        alert('Pilih Panitia terlebih dahulu!');
        return;
    }
    btn.disabled = true;
...
function openShowPenugasanModal(id, juriName, spesialisasi, lombaName, status, foto, fullName) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (statusParam) document.getElementById('filterStatus').value = statusParam;
