        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-3 p-sm-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('admin.create') }}" class="btn btn-success btn-sm rounded-pill px-4">
                                ...
                                <div class="card h-100 border-0 shadow-sm hover-card">
                                    ...
                                    <div class="card-footer bg-transparent border-0 pt-0 pb-3">
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('admin.show', $item->id_tim) }}" class="btn btn-outline-dark btn-sm flex-fill rounded-pill">
                                                <i class="fas fa-eye me-1"></i> Detail
                                            </a>
                                            <a href="{{ route('admin.edit', $item->id_tim) }}" class="btn btn-outline-warning btn-sm flex-fill rounded-pill">
                                                <i class="fas fa-edit me-1"></i> Edit
                                            </a>
                                            <form action="{{ route('admin.destroy', $item->id_tim) }}" method="POST" class="flex-fill">
                                                @csrf
                                                @method('DELETE')
