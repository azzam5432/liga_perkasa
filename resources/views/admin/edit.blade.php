    ...
    <div class="col-lg-10 offset-lg-1">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning text-white">
                <h5 class="mb-0"><i class="fas fa-user-edit me-2"></i> Edit Panitia</h5>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.update', $panitia->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted small mt-2">Upload foto baru untuk mengganti</p>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $panitia->name) }}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="{{ old('email', $panitia->email) }}" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('no_telp') is-invalid @enderror" 
                                       id="no_telp" name="no_telp" value="{{ old('no_telp', $panitia->no_telp) }}" required>
                                @error('no_telp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('jabatan') is-invalid @enderror" 
                                       id="jabatan" name="jabatan" value="{{ old('jabatan', $panitia->jabatan) }}" required>
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('instagram') is-invalid @enderror" 
                                       id="instagram" name="instagram" value="{{ old('instagram', $panitia->instagram) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('facebook') is-invalid @enderror" 
                                       id="facebook" name="facebook" value="{{ old('facebook', $panitia->facebook) }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('twitter') is-invalid @enderror" 
                                       id="twitter" name="twitter" value="{{ old('twitter', $panitia->twitter) }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('linkedin') is-invalid @enderror" 
                                       id="linkedin" name="linkedin" value="{{ old('linkedin', $panitia->linkedin) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('bio') is-invalid @enderror" 
                                  ...
                                  placeholder="Tuliskan sedikit tentang panitia ini...">{{ old('bio', $panitia->bio) }}</textarea>
                        @error('bio')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
